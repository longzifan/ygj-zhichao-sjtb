...
public class Base64Utils {
     ...
     * @return 文件的大小
     */
    public int getFileSize(SmbFile inFile){
        InputStream in = null;

        try {
            in = new SmbFileInputStream(inFile);
            //文件长度
     ...
     * @throws Exception
     */
    public String file2Base64(SmbFile inFile){
     ...
     * @return
     */
    private byte [] copyFile2Byte(SmbFile inFile){
        ...
        try {
            in =new SmbFileInputStream(inFile);
            //定义数组
//            System.out.println("文件长度"+inFile.length());
